# Metodología de Desarrollo - Sistema Ranger

Este documento define la metodología de trabajo para el desarrollo de proyectos Ranger utilizando un sistema de agentes coordinados.

**IMPORTANTE**: Esta metodología se aplica al proyecto **RangerNomina** ubicado en `E:\ranger sistemas\`.

**Estructura de directorios base**:
- Raíz del proyecto: `E:\ranger sistemas\`
- Documentación: `E:\ranger sistemas\Docs\`
- Backend: `E:\ranger sistemas\backend-ranger-nomina\`
- Frontend: `E:\ranger sistemas\rangernomina-frontend\`
...
1. **Leer CLAUDE.md** - Contexto del proyecto (ubicado en `E:\ranger sistemas\CLAUDE.md`)
2. **Leer Metodologia.md** - Este archivo (ubicado en `E:\ranger sistemas\Metodologia.md`)
3. **Escanear directorios clave**:
   - `E:\ranger sistemas\Docs\plans\` - Planes de desarrollo por fase
   - `E:\ranger sistemas\Docs\tasks\` - Archivos de tareas con estado actual

#### 1.2. Selección de Tarea

```bash
# Directorios a revisar
E:\ranger sistemas\Docs\
├── plans/
│   ├── plan_T001_YYYYMMDD.md
│   ├── plan_T002_YYYYMMDD.md
│   └── ...
└── tasks/
    ├── tareas_fase_actual_YYYYMMDD.md
    └── ...
```
...
2. **Lanzar subagente** usando `Task` tool:
   ...
   Lee el archivo E:\ranger sistemas\Docs\tasks\tareas_fase_actual_YYYYMMDD.md y busca la tarea [T00X].

   Sigue la metodología del subagente en E:\ranger sistemas\Metodologia.md sección 2.

   Debes:
   1. Leer la metodología del subagente
   2. Crear un plan detallado en E:\ranger sistemas\Docs\plans\plan_T00X_YYYYMMDD.md
   3. Ejecutar la tarea completando todos los criterios de aceptación
   4. Crear archivo de resultado en E:\ranger sistemas\Docs\completed\T00X_nombre_tarea.md
...
1. **Validar completitud**:
   - ✅ Plan creado en `E:\ranger sistemas\Docs\plans\plan_T00X_YYYYMMDD.md`
   - ✅ Archivo de resultado en `E:\ranger sistemas\Docs\completed\T00X_nombre_tarea.md`
...
1. **Generar reporte de fase**:
   - Archivo: `E:\ranger sistemas\Docs\reports\reporte_faseN_YYYYMMDD.md`
...
1. **Leer contexto**:
   - `E:\ranger sistemas\CLAUDE.md` - Contexto del proyecto
   - `E:\ranger sistemas\Metodologia.md` - Esta sección (Metodología del Subagente)
   - Archivo de tareas asignado (ej: `E:\ranger sistemas\Docs\tasks\tareas_fase_actual_YYYYMMDD.md`)
...
1. **Crear archivo de plan**:
   - Ubicación: `E:\ranger sistemas\Docs\plans\plan_T00X_YYYYMMDD.md`
...
1. **Crear archivo de completitud**:
   - Ubicación: `E:\ranger sistemas\Docs\completed\T00X_nombre_tarea.md`
   - Formato: Markdown estructurado
...
📋 Archivos generados:
- E:\ranger sistemas\Docs\plans\plan_T00X_YYYYMMDD.md (Plan de ejecución)
- E:\ranger sistemas\Docs\completed\T00X_nombre_tarea.md (Resultado documentado)
...
```
E:\ranger sistemas\
├── CLAUDE.md                    # Contexto del proyecto RangerNomina
├── Metodologia.md               # Este archivo
├── Docs/                        # Documentación del proyecto
│   ├── plans/                   # Planes de tareas individuales
│   │   ├── plan_T001_20260119.md
│   │   ├── plan_T002_20260119.md
│   │   └── ...
│   ├── tasks/                   # Archivos de tareas
│   │   ├── tareas_fase_actual_20260119.md
│   │   └── ...
│   ├── completed/               # Resultados de tareas completadas
│   │   ├── T001_nombre_tarea.md
│   │   └── ...
│   ├── decisions/               # ADRs (Architecture Decision Records)
│   │   ├── 001_decision_ejemplo.md
│   │   └── ...
│   ├── reports/                 # Reportes de finalización de fase
│   │   └── reporte_fase_YYYYMMDD.md
│   ├── logs/                    # Logs del coordinador (opcional)
│   │   └── coordinador_log_20260119.md
│   └── screenshots/             # Capturas de pantalla
├── backend-ranger-nomina/       # Código del backend (Node.js + Express)
├── rangernomina-frontend/       # Código del frontend (Angular)
...
### Escenario: Completar T002 - Investigar funcionalidad específica

#### Paso 1: Coordinador - Selección
```
1. Leo E:\ranger sistemas\Docs\tasks\tareas_fase_actual_20260119.md
...
5. Lanzo subagente general-purpose con prompt:
   "Completa T002 - [Descripción de la tarea]
    Lee E:\ranger sistemas\Docs\tasks\tareas_fase_actual_20260119.md para detalles
    Sigue metodología del subagente en E:\ranger sistemas\Metodologia.md"
```

#### Paso 3: Subagente - Planificación
```
6. Leo E:\ranger sistemas\CLAUDE.md, E:\ranger sistemas\Metodologia.md,
   E:\ranger sistemas\Docs\tasks\tareas_fase_actual_20260119.md
7. Creo plan en E:\ranger sistemas\Docs\plans\plan_T002_20260119.md con:
   - [Subtarea 1]
   - [Subtarea 2]
   - [Subtarea 3]
   - [Subtarea 4]
...
16. Creo E:\ranger sistemas\Docs\completed\T002_nombre_tarea.md con:
...
18. Informo al coordinador:
    "✅ TAREA COMPLETADA: T002 - [Nombre de la Tarea]
     📋 Archivos: plan_T002_20260119.md, T002_nombre_tarea.md
...
20. Actualizo E:\ranger sistemas\Docs\tasks\tareas_fase_actual_20260119.md:
    - Estado: [ ] → [✓]
    - Fecha finalización: 2026-01-19
    - Tiempo real: 4h 30min
    - Incremento tareas completadas: 2 → 3
21. Busco siguiente tarea (T003)
22. Lanzo nuevo subagente para T003
```
...
✅ Son independientes entre sí:
   - T007 modifica: backend-ranger-nomina/config/database.js, .env
   - T009 modifica: .env.example, backend-ranger-nomina/config/env.js
   - T011 modifica: E:\ranger sistemas\Docs\decisions\002_*.md (solo documentación)
✅ Estimaciones: T007 (3-4h), T009 (1-2h), T011 (2h) - todas >= 1h
✅ Todas son prioridad Alta

Archivos a modificar:
- T007: backend-ranger-nomina/config/database.js, .env
- T009: .env.example, backend-ranger-nomina/config/env.js
- T011: E:\ranger sistemas\Docs\decisions\002_estrategia_ejemplo.md

⚠️  Posible conflicto: Ninguno detectado
💡 Solución: Lanzar las 3 tareas en paralelo

Decisión final: Lanzar T007, T009 y T011 en paralelo
```
...
- Leer E:\ranger sistemas\Docs\completed\T007_*.md → ✅ Completo
- Leer E:\ranger sistemas\Docs\completed\T009_*.md → ✅ Completo
- Leer E:\ranger sistemas\Docs\completed\T011_*.md → ✅ Completo
...
- [ ] He leído `E:\ranger sistemas\CLAUDE.md`
- [ ] He leído `E:\ranger sistemas\Metodologia.md` (este archivo)
- [ ] He leído el archivo de tareas más reciente en `E:\ranger sistemas\Docs\tasks\`
...
- [ ] He leído `E:\ranger sistemas\CLAUDE.md`
- [ ] He leído `E:\ranger sistemas\Metodologia.md` sección 2 (Metodología del Subagente)
- [ ] He leído el archivo de tareas asignado en `E:\ranger sistemas\Docs\tasks\`
- [ ] He identificado mi tarea específica (T00X)
- [ ] He verificado que no hay dependencias bloqueadas
- [ ] He creado un plan detallado en `E:\ranger sistemas\Docs\plans\`
...
**Versión**: 2.1 (Adaptada para proyecto RangerNomina con rutas absolutas)
**Proyecto**: RangerNomina - Sistema de Gestión de Nómina
**Ubicación**: `E:\ranger sistemas\`
